package cz.cvut.fel.schematicEditor.piccolo.guiAdvanced.guiElements.partPropertiesDialog;
...
public class PartPropertiesDialog extends JDialog implements ActionListener {
    ...
    public PartPropertiesDialog(JFrame frame, boolean modal) {
        ...
        this.myPanel.add(PartPropertiesDialogPanel.getInstance());
    ...
    public void actionPerformed(ActionEvent e) {
        if (this.yesButton == e.getSource()) {
            ...
            PartPropertiesDialogPanel.getInstance().actualizeProperties();
            setAccepted(true);
