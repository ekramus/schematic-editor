package cz.cvut.fel.schematicEditor.piccolo.guiAdvanced.guiElements.gui;
...
import cz.cvut.fel.schematicEditor.piccolo.guiAdvanced.guiElements.gui.listeners.SceneTabbedPaneChangeListener;
import cz.cvut.fel.schematicEditor.piccolo.guiAdvanced.guiElements.menuBar.MenuBar;
import cz.cvut.fel.schematicEditor.piccolo.guiAdvanced.guiElements.propertiesPanel.PropertiesSelectorToolBar;
...
public class Gui extends JApplet {
    ...
    private void initRootComponent(Container container) {
        ...
        container.add(PropertiesSelectorToolBar.getInstance(), BorderLayout.EAST);
