...
public class SceneGraph implements Iterable<Node> {
    ...
    public void manualCreateSceneGraph() {
        ...
        // U vzor
        // Arc arc = new Arc(new cz.cvut.fel.schematicEditor.types.Point2D.Double(0,0), 50, 0, 359);
    ...
    /**
     * @deprecated This method returns list of Boundig Boxes of each group. It should be not used,
     *             as it does not provide direct link to Elements , which Bounding Box is linked to
     *             which element.
     * @return
     */
    @Deprecated
     ...
     * @return LinkedList of GroupNodes, which were located at least partly inside given
     *         areaOfInterest.
     */
    public LinkedList<ElementNode> getElementNodeList(Rectangle2D.Double areaOfInterest) {
        ...
        for (Node node : this) {
            ...
            if (node instanceof ElementNode) {
                ...
                if (areaOfInterest.contains(en.getBounds(boundModifier)) || areaOfInterest
                        .intersects(en.getBounds(boundModifier))) {
