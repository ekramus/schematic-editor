 ...
 */
public class CurrentControlledSwitchProperties extends LightweightPartProperties {

    /**
     * This method instantiates new instance.
     */
    public CurrentControlledSwitchProperties() {
        super();
    ...
    public PartType getPartType() {
        return PartType.CURRENT_CONTROLLED_SWITCH;
    }
    ...
    public PartProperties duplicate() {
        return new CurrentControlledSwitchProperties();
    }
}
