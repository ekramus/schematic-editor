 ...
 */
public class LinearVoltageControlledCurrentSourceProperties extends LightweightPartProperties {

    /**
     * This method instantiates new instance.
     */
    public LinearVoltageControlledCurrentSourceProperties() {
        super();
    ...
    public PartType getPartType() {
        return PartType.LINEAR_VOLTAGE_CONTROLLED_CURRENT_SOURCE;
    }
    ...
    public PartProperties duplicate() {
        return new LinearVoltageControlledCurrentSourceProperties();
    }
}
