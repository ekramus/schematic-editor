 ...
 */
public class LinearCurrentControlledVoltageSourceProperties extends LightweightPartProperties {

    /**
     * This method instantiates new instance.
     */
    public LinearCurrentControlledVoltageSourceProperties() {
        super();
    ...
    public PartType getPartType() {
        return PartType.LINEAR_CURRENT_CONTROLLED_VOLTAGE_SOURCE;
    }
    ...
    public PartProperties duplicate() {
        return new LinearCurrentControlledVoltageSourceProperties();
    }
}
