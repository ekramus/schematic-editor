 ...
 */
public class OperationAmpProperties extends LightweightPartProperties {

    /**
     * This method instantiates new instance.
     */
    public OperationAmpProperties() {
        super();
    ...
    public PartProperties duplicate() {
        return new OperationAmpProperties();
    }
}
