...
/**
 * This class encapsulates electronic part informations. Shape of part is
 * represented as <code>GroupNode</code>.
 * 
...
public class Part extends Element {
	...
	/**
	 * @see element.Element#isHit(java.awt.geom.cz.cvut.fel.schematicEditor.types
	 *      .Point2D.Double)
	 */
	@Override
